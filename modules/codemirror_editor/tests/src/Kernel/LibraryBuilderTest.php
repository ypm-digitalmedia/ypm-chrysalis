...
class LibraryBuilderTest extends KernelTestBase {
  ...
  protected $remoteFixture = [
    ...
    'js' => [
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/lib/codemirror.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/mode/xml/xml.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/mode/clike/clike.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/mode/php/php.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/mode/css/css.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/fold/foldcode.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/fold/foldgutter.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/fold/brace-fold.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/fold/xml-fold.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/fold/comment-fold.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/display/autorefresh.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/display/fullscreen.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/display/placeholder.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/mode/overlay.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/edit/closetag.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/comment/comment.js' => ['type' => 'external'],
      'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/selection/active-line.js' => ['type' => 'external'],
    ],
    'css' => [
      'component' => [
        'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/lib/codemirror.css' => ['type' => 'external'],
        'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/fold/foldgutter.css' => ['type' => 'external'],
        'https://cdn.jsdelivr.net/npm/codemirror@5.48.2/addon/display/fullscreen.css' => ['type' => 'external'],
      ],
    ],
  ];
